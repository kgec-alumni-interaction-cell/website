      ...
      <ul className="list-inside flex-col">
        {notices.map((notice, idx) => (
          <li key={idx} className="flex my-3 ">
            ...
            <a className="ml-1 text-blue-500 transition duration-150 ease-in-out hover:text-blue-600 focus:text-blue-600 active:text-blue-700" href={notice.link}>{notice.title}</a>
          </li>
        ))}
      </ul>
    </section>
